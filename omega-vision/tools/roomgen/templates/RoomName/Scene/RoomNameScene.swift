...
struct RoomNameScene: View {
    ...
    // Preset selection.
    @State private var preset: ScenePreset = .default
            ...
            .gesture(
                TapGesture()
                    ...
                    .onEnded { value in
                        ...
                        // Skip non-selectable entities (halos, dash segments)
                        if name.contains("Uncertainty_Halo") || name.contains("Halo") || name.hasPrefix("DASH:") {
                            return
                        }
